...
SELECT ARSCHEDULEHEADER_ID, ARSCHEDULEDETAIL_ID, DATEDUE, TOTALDUE
	, CumulativeDue = (SELECT SUM(AMOUNTDUE) FROM ARSCHEDULEDETAIL WHERE ARSCHEDULEHEADER_ID = X.ARSCHEDULEHEADER_ID AND ARSCHEDULEDETAIL_ID <= X.ARSCHEDULEDETAIL_ID)
INTO #aging_schedule
FROM (
