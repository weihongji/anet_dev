...
SELECT @receiptheader_id = RECEIPTHEADER_ID FROM RECEIPTHEADERS WHERE RECEIPTNUMBER = 1000225.001
...
SELECT * FROM ICVERIFYLOG WHERE RECEIPTHEADER_ID = @receiptheader_id and RECEIPTNUMBER>0
