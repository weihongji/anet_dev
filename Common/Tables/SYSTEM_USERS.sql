...
/*
--Set password to "safari1"
UPDATE SYSTEM_USERS SET PASSWORD='safari1' WHERE SYSTEMUSER_ID = 2 AND PASSWORD='4ibf6o'

--UPDATE SYSTEM_USERS SET ACTIVENET_SITES_USER_ID = 0, PASSWORD='safari1', NEVER_EXPIRE = -1, USERNAME = 'recware' WHERE USERNAME = 'jwei'
--UPDATE SYSTEM_USERS SET PASSWORD='safari1', RETIRED = 0, NEVER_EXPIRE = -1, FAILED_LOGON_COUNT = 0 WHERE USERNAME = 'recware'
